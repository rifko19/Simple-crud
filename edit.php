...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `crud` SET `nama`='$nama',`nim`='$nim',`email`='$email',`alamat`='$alamat',`gender`='$gender' WHERE id=$id";
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-4">
            <h3>Edit data</h3>
            <p class="text-muted">klik perbarui setelah mengubah informasi</p>
        </div>
